...
export const weeklySchedule: WeeklySchedule[] = [
  {
    ...
    classes: [
      ...
      {
        time: '10:00-10:50 AM',
        program: 'Filipino Martial Arts & JKD (Equipment)',
        coach: 'Adult Class',
      },
      {
        time: '11:00-11:50 AM',
      ...
      {
        time: '5:00-5:45 PM',
        program: 'Beginner Juniors BBTC Weapons (Ages 7-13)',
        coach: 'Kids Class',
      },
      ...
      {
        time: '6:00-6:50 PM',
        program: 'Teen/Adult TKD Korean Karate - Weapons',
        coach: 'Adult Class',
      },
      {
        time: '6:00-6:55 PM',
        program: 'Junior Black Belts Weapons (Ages 10-13)',
        coach: 'Kids Class',
      },
      {
        time: '7:00-7:50 PM',
        program: 'Kids Brazilian Jiu Jitsu (Gi/Gi-less) Ages 5-13',
        coach: 'Kids Class',
      },
      {
        time: '7:00-8:00 PM',
  ...
  },
  {
    ...
    classes: [
      ...
      {
        time: '5:00-5:45 PM',
        program: 'Beginner Juniors BBTC Sparring (Ages 7-13)',
        coach: 'Kids Class',
      },
      {
        time: '5:20-5:50 PM',
        program: "Advanced Lil' Dragons Sparring (Ages 4-7)",
        coach: 'Kids Class',
      },
      {
        time: '6:00-6:45 PM',
      ...
      {
        time: '6:00-6:50 PM',
        program: 'Teen/Adult TKD Korean Karate - Sparring',
        coach: 'Adult Class',
      },
      {
        time: '6:00-6:55 PM',
        program: 'Junior Black Belts Sparring (Ages 10-13)',
        coach: 'Kids Class',
      },
      {
        time: '7:00-7:50 PM',
  ...
  },
  {
    ...
    classes: [
      ...
      {
        time: '5:00-5:45 PM',
        program: 'Kids Brazilian Jiu Jitsu (BJJ Gi) Ages 5-13',
        coach: 'Kids Class',
      },
      {
        time: '6:00-6:50 PM',
