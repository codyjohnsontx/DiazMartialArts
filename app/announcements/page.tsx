...
const flyers: AnnouncementFlyer[] = [
  ...
  {
    id: 'july-kids-class-schedule',
    src: '/announcements/july-2026-kids-class-schedule.jpg',
    alt: 'Diaz Martial Arts July 2026 kids class schedule',
    title: 'July Kids Class Schedule',
    tag: 'Schedule',
    date: 'July 2026',
    category: 'Events',
    width: 1998,
  ...
  {
    id: 'july-adult-class-schedule',
    src: '/announcements/july-2026-adult-class-schedule.jpg',
    alt: 'Diaz Martial Arts July 2026 adult class schedule',
    title: 'July Adult Class Schedule',
    tag: 'Schedule',
    date: 'July 2026',
    category: 'Events',
    width: 1998,
